...
node_features_file = os.path.join(data_dir, "spark_combined_output/brush/spieceasi/node_features.csv")
nfeatures_df = pd.read_csv(node_features_file, header=0, sep=',', index_col=0)
isa_type_file = os.path.join(data_dir, "spark_combined_output/brush/indicspecies/subclass2_indicator_species_results.tsv")
...
isa_status_file = os.path.join(data_dir, "spark_combined_output/brush/indicspecies/status_indicator_species_results.tsv")
...
type_summary_file = os.path.join(data_dir, "spark_combined_output/brush/indicspecies/subclass2_indicator_species_summary.tsv")
type_summary_df = pd.read_csv(type_summary_file, header=0, sep='\t')
type_summary_df.rename(columns={'ASV': 'ASV_ID'}, inplace=True)
status_summary_file = os.path.join(data_dir, "spark_combined_output/brush/indicspecies/status_indicator_species_summary.tsv")
...
venn_df = pd.read_csv(os.path.join(data_dir, "spark_combined_output/brush/metadata/Three_types_venn_presence_table.tsv"), sep="\t", header=0)
...
nfeat_type_df.to_csv(os.path.join(data_dir, "spark_combined_output/brush/spieceasi/node_features.type.tsv"),
                     sep='\t'
                     )

nfeat_status_df.to_csv(os.path.join(data_dir, "spark_combined_output/brush/spieceasi/node_features.status.tsv"),
                     sep='\t'
                     )
...
network_file = os.path.join(data_dir, "spark_combined_output/brush/spieceasi/network_pos_all.graphml")
...
plt.axis('off')
plt.tight_layout()
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_degree_plot_POS_ALL.svg"), bbox_inches='tight')
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_degree_plot_POS_ALL.pdf"), bbox_inches='tight')

network_file = os.path.join(data_dir, "spark_combined_output/brush/spieceasi/network_pos_sub.graphml")
G = nx.read_graphml(network_file)
# Add metadata to graph nodes
for node in G.nodes:
    if node in nfeat_type_df.index:
...
plt.axis('off')
plt.tight_layout()
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_degree_plot_POS_SUB.svg"), bbox_inches='tight')
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_degree_plot_POS_SUB.pdf"), bbox_inches='tight')
...
plt.axis('off')
plt.tight_layout()
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_abundance_plot.svg"), bbox_inches='tight')
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_abundance_plot.pdf"), bbox_inches='tight')
...
plt.axis('off')
plt.tight_layout()
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_status_plot.svg"), bbox_inches='tight')
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_status_plot.pdf"), bbox_inches='tight')
...
plt.axis('off')
plt.tight_layout()
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_type_plot_Phylum_ABUND.svg"), bbox_inches='tight')
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_type_plot_Phylum_ABUND.pdf"), bbox_inches='tight')
...
plt.axis('off')
plt.tight_layout()
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_type_plot_Phylum_ISA.svg"), bbox_inches='tight')
plt.savefig(os.path.join(data_dir, f"spark_combined_output/brush/spieceasi/network_type_plot_Phylum_ISA.pdf"), bbox_inches='tight')