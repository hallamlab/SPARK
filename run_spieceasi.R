...
if (!dir.exists("/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi")) {
  dir.create("/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi")
}
...
filtered_count_path <- "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/count_data_filtered.RDS"
spiec_easi_path <- "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/se_gl_cnt.RDS"
igraph_path <- "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/ig_gl.RDS"
layout_path <- "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/am_coord.RDS"
...
if (identical(ig.gl, FALSE) || identical(am.coord, FALSE)) {
  ...
  write.csv(precision_df, "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/precision_matrix.csv", row.names = FALSE)
  ...
  write.csv(partial_cor_df, "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/partial_correlation_matrix.csv", row.names = FALSE)
  ...
  write.csv(adj_df, "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/adj_STARS_matrix.csv", row.names = FALSE)
  ...
  write.csv(adj_df, "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/adj_weighted_matrix.csv", row.names = FALSE)
  ...
  pdf("/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/multipage_layouts.pdf", width = 10, height = 10)
  ...
  dev.off()
  write_graph(ig.gl, file = "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/network_pos_sub.graphml", format = "graphml")
  write_graph(ig.gl, file = "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/network_pos_sub.gml", format = "gml")
  write_graph(ig_signed, file = "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/network_signed.graphml", format = "graphml")
  write_graph(ig_signed, file = "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/network_signed.gml", format = "gml")
  write_graph(ig.gl.all, file = "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/network_pos_all.graphml", format = "graphml")
  write_graph(ig.gl.all, file = "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/network_pos_all.gml", format = "gml")
...
edge_list_path <- "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/edge_list.csv"
...
# Save the edge list as a CSV file
edge_list_path <- "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/edge_list_with_asv_ids.csv"
write.csv(edge_list, edge_list_path, row.names = FALSE)
...
write.csv(node_features, "/home/ryan/SeqData/SeqData/UBC/LMP_priority1/final_output/spieceasi/node_features.csv", row.names = FALSE)
