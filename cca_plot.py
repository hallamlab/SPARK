...
# Load your tables
asv_path = os.path.join(output_dir, "ASVs/ASV_filtered.micro.tsv")
...
cbar_ax = g.fig.add_axes([0.80, 0.3, 0.05, 0.3])  # [x, y, width, height]
...
#g.ax_heatmap.tick_params(axis='both', labelsize=24)
#g.ax_row_dendrogram.tick_params(axis='both', labelsize=24)
#g.ax_col_dendrogram.tick_params(axis='both', labelsize=24)
